                ...
                <div class="col-lg-4 col-md-12">
                    <div class="sidebar-area">
                        ...
                        <div class="sidebar-section category-area">
                            ...
                            <a class="category" href="{{ url('news/'.$category->category_id) }}">
                                <img src="{{ url($category->image) }}" alt="{{$category->category_id}}">
                                <h6 class="name">{{$category->category_id}}</h6>
                            </a>
                            @endforeach
                        ...
                        <div class="sidebar-section latest-post-area">
                            ...
                            <div class="latest-post" href="{{ url('news/'.$posts->category->category_id.'/'.$posts->slug) }}>
                                <div class="l-post-image"><img src="{{ url($posts->banner) }}" alt="Category Image"></div>
                                <div class="post-info">
                                    <a class="btn category-btn" href="{{ url('news/'.$posts->category->category_id) }}">{{$posts->category->category_id}}</a>
                                    <h5><a href="{{ url('news/'.$posts->category->category_id.'/'.$posts->slug) }}"><b class="light-color">{{ $posts->title }}</b></a></h5>
                        ...
                        <div class="sidebar-section tags-area">
                            ...
                            <ul class="tags">
                                @foreach ($data['category'] as $category)
                                <li><a class="btn" href="{{ url('news/'.$category->category_id) }}">{{ $category->category_id }}</a></li>
                                @endforeach
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="footer-section">
                        <p class="copyright">Backend Test | &copy; 2021. All rights reserved</p>
                    </div><!-- footer-section -->
