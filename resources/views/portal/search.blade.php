...
<div class="recomend-area">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="recomend">
                <div class="post-image"><img src="{{ url($posts->banner) }}" alt="Post Image"></div>

                <div class="post-info">
                    <a class="btn category-btn" href="{{ url('news/'.$posts->category->category_id) }}">{{$posts->category->category_id}}</a>
                    <h5 class="title"><a href="{{ url('news/'.$posts->category->category_id.'/'.$posts->slug) }}><b class="light-color">{{ substr($posts->title, 0, 30).(strlen($posts->title) > 30 ? "..." : "") }}</b></a></h5>
